...
const STEPS = [
  ...
  { icon: Share2, title: "Route", text: "Send unresolved cases to a human-reviewed worklist." },
];
    ...
    <div>
      ...
      <header className="mb-6" data-demo="headline">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          >
            <Play size={14} /> 60-second guided demo
          </button>
          <button
          ...
          >
            Open example case <ArrowRight size={14} />
          </button>
          ...
          <div className="p-5 lg:col-span-3">
            ...
            <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="rounded-lg bg-teal-50 px-3 py-2.5">
                <div className="text-sm font-medium text-teal-900">Follow-up already visible</div>
                <p className="mt-0.5 text-xs leading-relaxed text-teal-800">Stand down — no worklist case is created.</p>
              </div>
      ...
      <Card className="p-5">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-600">
          ...
          deformity. No relevant follow-up evidence is visible, and no one owns the case.
        </p>
        <button
          onClick={() => onOpen("FB-04417")}
