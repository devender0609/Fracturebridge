...
import { ArrowRight, ShieldCheck, UserCheck, FileSearch, HeartHandshake } from "lucide-react";
    ...
    <div>
      ...
      <Card className="mb-6">
        <div className="grid grid-cols-2 divide-x divide-y divide-slate-100 md:grid-cols-4 md:divide-y-0">
          ...
          <Stat n={aging} label="Aging >30 days" sub="needs attention" tone="text-rose-700" />
          <Stat n={closed} label="Closed" sub="plan documented" tone="text-emerald-700" />
        </div>
      </Card>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-5">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            ...
            <div className="rounded-lg bg-amber-50 p-3"><div className="text-xs text-amber-700">Follow-up evidence</div><div className="mt-1 text-sm font-semibold text-amber-900">Not found</div></div>
