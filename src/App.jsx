...
const DEMO_STEPS = [
  ...
  { view: "overview", target: "funnel", say: "Follow-up already visible → stand down. Follow-up not visible → a potential gap that goes to a human." },
  ...
  { view: "safety", target: null, say: "How it works: what the AI does, what people decide, and how this could connect to an EHR one day." },
];
